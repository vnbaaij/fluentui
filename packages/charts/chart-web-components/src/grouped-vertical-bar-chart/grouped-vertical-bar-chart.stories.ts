...
const basicData: GroupedVerticalBarChartData[] = [
  {
    xAxisPoint: 'Jan - Mar',
    series: [
      { key: '2022', data: 33000, color: 'qualitative.3' },
      { key: '2023', data: 44000, color: 'qualitative.4' },
      { key: '2024', data: 54000, color: 'qualitative.5' },
      { key: '2021', data: 24000, color: 'qualitative.6' },
    ],
  },
  {
    xAxisPoint: 'Apr - Jun',
    series: [
      { key: '2022', data: 33000, color: 'qualitative.3' },
      { key: '2023', data: 3000, color: 'qualitative.4' },
      { key: '2024', data: 9000, color: 'qualitative.5' },
      { key: '2021', data: 12000, color: 'qualitative.6' },
    ],
  },
  {
    xAxisPoint: 'Jul - Sep',
    series: [
      { key: '2022', data: 14000, color: 'qualitative.3' },
      { key: '2023', data: 50000, color: 'qualitative.4' },
      { key: '2024', data: 60000, color: 'qualitative.5' },
      { key: '2021', data: 10000, color: 'qualitative.6' },
    ],
  },
  {
    xAxisPoint: 'Oct - Dec',
    series: [
      { key: '2022', data: 33000, color: 'qualitative.3' },
      { key: '2023', data: 3000, color: 'qualitative.4' },
      { key: '2024', data: 6000, color: 'qualitative.5' },
      { key: '2021', data: 15000, color: 'qualitative.6' },
    ],
  },
];
